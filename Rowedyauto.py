...
"""
os.system('clear')
print('             \x1b[38;5;46m WELCOME TO R0W3DY KIING WORLD          ')
time.sleep(5)
#------------------[ PROXY SERVER ]-------------------#
def load_proxies():
...
folder_path = '/sdcard/AUTO_CREATE_ROWEDY_KIING'
try:
...
|__/  |__/ \______/ |__/     \__/|_______/     |__/    
                  ...
                  OWNER ROWEDY KIING( राजस्थान सरकार )                                
                                                       

\033[1;34m────────────────────────────────────────────────────────
 \033[1;32m[\033[1;31m–\033[1;32m] AUTHOR   : R0W3DY KIING (TUSHAR KI BEHAN KA ASHIQ)
...
def auto_create_fb_method_1_() -> None:
    ...
    for make in range(50000):
        ...
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}R0W3DY-XD\033[1;37m]<×>[{make+1}|\033[1;32m{oks}\033[1;37m]> ');sys.stdout.flush()
        #sys.stdout.write(f"\r\r\033[1;37m[R0W3DY-CREATE] {make+1}\033[1;37m|\033[1;32mOK-:{len(oks)}\033[1;37m");sys.stdout.flush()
        ...
        if "c_user" in py_submit.cookies:
            ...
            print('\r\033[1;32m<[R0W3DY-XD-OK]> ' + uid + ' | ' + pasw2 + '\033[1;37m')
            ...
            #linex()
            file_path_ok = os.path.join(folder_path, 'R0W3DY-XD-CREATE-OK.txt')
            file_path_cookies = os.path.join(folder_path, 'R0W3DY-XD-CREATE-COOKIE.txt')
...
def auto_create_fb_method_2_() -> None:
    ...
    for make in range(1000):
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}R0W3DY-XD\033[1;37m]<×>[{make+1}|\033[1;32m{len(ok)}\033[1;37m]> ');sys.stdout.flush()
        ses = requests.Session()
        fake = Faker()
